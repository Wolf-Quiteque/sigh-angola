...
| Testes de domínio, repositório e migração | 33 passaram                                                    |
| Build de produção                         | Concluído; 11 ecrãs e 2 fichas dinâmicas                       |
| Testes de navegador                       | 9 passaram                                                     |
| Migração dos dados das fases 1 e 2        | Pacientes, marcações, episódios, clínica e revisão preservados |
...
Os destinos «Internamento» e «Transferência» são registados como decisão clínica; a criação efectiva do internamento ou transferência será implementada na fase 4.
